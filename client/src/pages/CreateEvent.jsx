    ...
    <>
      ...
      <div className="flex justify-around ">
        ...
        <ul className="flex justify-end">
          <li className="mr-3">
            <a
              className="inline-block border border-red-500 rounded py-1 px-3 bg-red-500 text-black align-right"
              href=""
            >
              Approve
            </a>
              ...
              <table className="w-full text-sm text-left text-blue-100 dark:text-blue-100">
                ...
                <tfoot>
                  <tr>
                    <td colSpan="3">
                      <button
                        className="text-black bg-blue-500 hover:bg-blue-700 text-sm py-2 px-4 rounded-md"
                        onClick={addRow1}
                      >
                        Add row
                      </button>
